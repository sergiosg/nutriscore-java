...
class NutriscoreTest {
	...
	public void testA_24024228() {
		...
		final Product product = new Product.ProductBuilder().energy(1121f).fat(3f).saturatedFat(0.5f).sugar(0.5f).fiber(3f).proteins(9f).sodium(0.315f).build();
	...
	public void testB_8001091000414() {
		...
		final Product product = new Product.ProductBuilder().energy(179f).fat(5.5f).saturatedFat(0.74f).sugar(2.7f).sodium(0.394f).build();
	...
	public void testE_3273220087930() {
		...
		final Product product = new Product.ProductBuilder().energy(314f).fat(1.5f).saturatedFat(0.3f).sugar(10f).fiber(1.5f).proteins(2.5f).sodium(0.354f).build();
